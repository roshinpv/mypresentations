...
export const agenciesAPI = {
  ...
  create: async (agencyData: { name: string; description: string }) => {
    const response = await api.post('/agencies', agencyData);
    return response.data;
  },
  
  update: async (id: string, agencyData: { name: string; description: string }) => {
...
export const banksAPI = {
  ...
  create: async (bankData: { name: string }) => {
    const response = await api.post('/banks', bankData);
    return response.data;
  },
  
  update: async (id: string, bankData: { name: string }) => {
